...
if TYPE_CHECKING:
    ...
    from nanobot.agent.tools.image_understanding import ImageUnderstandingToolConfig
...
class ToolsConfig(Base):
    ...
    image_understanding: ImageUnderstandingToolConfig = Field(
        default_factory=lambda: _lazy_default("nanobot.agent.tools.image_understanding", "ImageUnderstandingToolConfig"),
    )
...
def _resolve_tool_config_refs() -> None:
    ...
    mod.ImageUnderstandingToolConfig = ImageUnderstandingToolConfig  # type: ignore[attr-defined]
